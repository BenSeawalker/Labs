...
//////////
	...
	{
		Employee::Display();
		*(Output()) << setw(9) << "Rate: " << setw(10) << right << m_rate << setw(13) << left << "\tHours: " << setw(8) << right << m_hours << left << endl; // setw(10) = in case employee is in the 6 digit range...
	}
