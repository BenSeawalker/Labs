...
//////////
	...
	************************************************************************/
	...
	{
		return char(m_lastName[0]);
	}


	bool Employee::operator==(const Employee & _emp) const
	{
		return (m_lastName.compare(_emp.m_lastName) == 0);
	}
	bool Employee::operator<=(const Employee & _emp) const
	{
		return (m_lastName.compare(_emp.m_lastName) <= 0);
	...
	bool operator==(const Employee & _emp, const string & _key)
	{
		return (_emp.m_lastName.compare(_key) == 0);
	}
	bool operator!=(const Employee & _emp, const string & _key)
	{
		return !(_emp == _key);
