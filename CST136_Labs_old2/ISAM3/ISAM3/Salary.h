...
public:
	Salary();
	Salary(const string & _worknum, const string & _last, const string & _first, const string & _bdate, const string & _employed,
		int _sales, float _commision, stringstream * _output);
