...
{
public:
	Temporary(const string & _worknum, const string & _last, const string & _first,	const string & _bdate, const string & _employed,
		float _rate, float _hours, stringstream * _output);
