...
*
* Manager functions:
* 	Block (int(*compare_type)(T *, T *), bool(*compare_key)(T *, string &))
...
{
public:
	Block(int(*CompareType)(const T * _t1, const T * _t2), int(*CompareKey)(const T * _t, const string & _key));
	~Block();
...
//////////
	...
	template<class T>
	Block<T>::Block(int(*CompareType)(const T * _t1, const T * _t2), int(*CompareKey)(const T * _t, const string & _key))
	{
